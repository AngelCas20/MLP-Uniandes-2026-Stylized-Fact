...
tabla_panel[17] = "\\tabularnewline"
tabla_panel[30] = "\\tabularnewline"
tabla_panel[34] = "\\tabularnewline"

##==: 7. Save table

write_lines(tabla_panel,'05_visuals/output/06_tabla_5_annex_fe_main_elasticity.tex')
