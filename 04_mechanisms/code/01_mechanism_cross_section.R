...
df = import('02_wrangle/output/02_geometric_growth_mechanism.rds',
            setclass = 'tibble')
...
export(model_first_step,'04_mechanisms/output/01_mechanism_cross_section_banking_on_mechanism.rds')
export(model_second_step,'04_mechanisms/output/01_mechanism_cross_section_capital_on_mechanism.rds')